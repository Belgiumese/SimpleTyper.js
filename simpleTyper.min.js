...
"";for(var d in a.settings)(c=a.elem.attr("data-typer-"+d))&&(a.settings[d]=parseInt(c,10));a.id=e.length;a.elem.attr("data-typer-id",a.id);e.push(a)});return c},startAll:function(){for(var a=0;a<e.length;a++)e[a].startType();return c},settings:function(a){b.extend(f,a);return c},start:function(a){e[b(a).attr("data-typer-id")].startType();return c},stop:function(a){e[b(a).attr("data-typer-id")].stopType();return c}},e=[],g={chars:0,text:"",textTimer:void 0,cursorTimer:void 0,settings:{},startType:function(){this.startCursor();
